...
(defcfun ("cna_game_set_window_title" %game-set-window-title) :uint32
  (game :uint64) (title-0 :uint64) (title-1 :uint64))
...
(defcfun ("cna_texture2d_create_from_file_with_device" %texture-2d-create-from-file-with-device) :uint32
  (graphics-device :uint64) (path-0 :uint64) (path-1 :uint64) (out-texture :pointer))
...
(defparameter *bound-native-functions*
  '(("cna_get_abi_version" :uint32 () :thread :any :ownership "none")
    ("cna_error_get_last_info" :uint32 (:pointer) :thread :any :ownership "none")
    ("cna_error_get_last_message_size" :uint32 (:pointer) :thread :any :ownership "none")
    ("cna_error_copy_last_message" :uint32 (:pointer :uint64 :pointer) :thread :any :ownership "none")
    ("cna_game_create" :uint32 (:pointer :pointer) :thread :creates-affinity :ownership "creates-owned:game")
    ("cna_game_destroy" :uint32 (:uint64) :thread :owner :ownership "destroys:game")
    ("cna_game_run" :uint32 (:uint64) :thread :owner :ownership "none")
    ("cna_game_run_one_frame" :uint32 (:uint64) :thread :owner :ownership "none")
    ("cna_game_tick" :uint32 (:uint64) :thread :owner :ownership "none")
    ("cna_game_request_exit" :uint32 (:uint64) :thread :owner :ownership "none")
    ("cna_game_suppress_draw" :uint32 (:uint64) :thread :owner :ownership "none")
    ("cna_game_reset_elapsed_time" :uint32 (:uint64) :thread :owner :ownership "none")
    ("cna_game_clear" :uint32 (:uint64 :uint32) :thread :owner :ownership "none")
    ("cna_game_set_window_title" :uint32 (:uint64 :uint64 :uint64) :thread :owner :ownership "none")
    ("cna_game_set_frame_hooks_ext" :uint32 (:uint64 :pointer) :thread :owner :ownership "borrows-table:copied-during-call")
    ("cna_game_get_is_active" :uint32 (:uint64 :pointer) :thread :owner :ownership "none")
    ("cna_game_get_is_mouse_visible" :uint32 (:uint64 :pointer) :thread :owner :ownership "none")
    ("cna_game_set_is_mouse_visible" :uint32 (:uint64 :uint8) :thread :owner :ownership "none")
    ("cna_game_get_is_fixed_time_step" :uint32 (:uint64 :pointer) :thread :owner :ownership "none")
    ("cna_game_set_is_fixed_time_step" :uint32 (:uint64 :uint8) :thread :owner :ownership "none")
    ("cna_game_get_target_elapsed_time_ticks" :uint32 (:uint64 :pointer) :thread :owner :ownership "none")
    ("cna_game_set_target_elapsed_time_ticks" :uint32 (:uint64 :int64) :thread :owner :ownership "none")
    ("cna_game_get_inactive_sleep_time_ticks" :uint32 (:uint64 :pointer) :thread :owner :ownership "none")
    ("cna_game_set_inactive_sleep_time_ticks" :uint32 (:uint64 :int64) :thread :owner :ownership "none")
    ("cna_game_get_type_name_size" :uint32 (:uint64 :pointer) :thread :owner :ownership "none")
    ("cna_game_copy_type_name" :uint32 (:uint64 :pointer :uint64 :pointer) :thread :owner :ownership "none")
    ("cna_game_get_graphics_device" :uint32 (:uint64 :pointer) :thread :owner :ownership "borrows-callback-scoped:graphics-device")
    ("cna_graphics_device_get_viewport" :uint32 (:uint64 :pointer) :thread :owner :ownership "none")
    ("cna_graphics_device_clear_rgba" :uint32 (:uint64 :float :float :float :float) :thread :owner :ownership "none")
    ("cna_graphics_device_present" :uint32 (:uint64) :thread :owner :ownership "none")
    ("cna_graphics_device_get_renderer_info" :uint32 (:uint64 :pointer) :thread :owner :ownership "none")
    ("cna_graphics_device_copy_renderer_name" :uint32 (:uint64 :pointer :uint64 :pointer) :thread :owner :ownership "none")
    ("cna_graphics_device_get_type_name_size" :uint32 (:uint64 :pointer) :thread :owner :ownership "none")
    ("cna_graphics_device_copy_type_name" :uint32 (:uint64 :pointer :uint64 :pointer) :thread :owner :ownership "none")
    ("cna_graphics_device_manager_create" :uint32 (:uint64 :pointer) :thread :owner :ownership "creates-owned:graphics-device-manager")
    ("cna_graphics_device_manager_destroy" :uint32 (:uint64) :thread :owner :ownership "destroys:graphics-device-manager")
    ("cna_graphics_device_manager_apply_changes" :uint32 (:uint64) :thread :owner :ownership "none")
    ("cna_graphics_device_manager_toggle_full_screen" :uint32 (:uint64) :thread :owner :ownership "none")
    ("cna_graphics_device_manager_get_is_full_screen" :uint32 (:uint64 :pointer) :thread :owner :ownership "none")
    ("cna_graphics_device_manager_set_is_full_screen" :uint32 (:uint64 :uint8) :thread :owner :ownership "none")
    ("cna_graphics_device_manager_get_preferred_back_buffer_width" :uint32 (:uint64 :pointer) :thread :owner :ownership "none")
    ("cna_graphics_device_manager_set_preferred_back_buffer_width" :uint32 (:uint64 :int32) :thread :owner :ownership "none")
    ("cna_graphics_device_manager_get_preferred_back_buffer_height" :uint32 (:uint64 :pointer) :thread :owner :ownership "none")
    ("cna_graphics_device_manager_set_preferred_back_buffer_height" :uint32 (:uint64 :int32) :thread :owner :ownership "none")
    ("cna_graphics_device_manager_get_synchronize_with_vertical_retrace" :uint32 (:uint64 :pointer) :thread :owner :ownership "none")
    ("cna_graphics_device_manager_set_synchronize_with_vertical_retrace" :uint32 (:uint64 :uint8) :thread :owner :ownership "none")
    ("cna_graphics_device_manager_get_graphics_device" :uint32 (:uint64 :pointer) :thread :owner :ownership "borrows-callback-scoped:graphics-device")
    ("cna_texture2d_create_from_encoded_memory" :uint32 (:uint64 :pointer :uint64 :pointer :pointer) :thread :owner :ownership "creates-owned:texture-2d:child-of-game")
    ("cna_texture2d_create_from_file_with_device" :uint32 (:uint64 :uint64 :uint64 :pointer) :thread :owner :ownership "creates-owned:texture-2d:child-of-game")
    ("cna_texture2d_destroy" :uint32 (:uint64) :thread :owner :ownership "destroys:texture-2d")
    ("cna_texture2d_get_storage_info" :uint32 (:uint64 :pointer) :thread :owner :ownership "none")
    ("cna_texture2d_get_type_name_byte_count" :uint32 (:uint64 :pointer) :thread :owner :ownership "none")
    ("cna_texture2d_copy_type_name" :uint32 (:uint64 :pointer :uint64 :pointer) :thread :owner :ownership "none")
    ("cna_texture_get_info" :uint32 (:uint64 :pointer) :thread :owner :ownership "none")
    ("cna_sprite_batch_create" :uint32 (:uint64 :pointer) :thread :owner :ownership "creates-owned:sprite-batch:child-of-game")
    ("cna_sprite_batch_destroy" :uint32 (:uint64) :thread :owner :ownership "destroys:sprite-batch")
    ("cna_sprite_batch_begin" :uint32 (:uint64 :pointer) :thread :owner :ownership "none")
    ("cna_sprite_batch_submit_many" :uint32 (:uint64 :pointer :uint64) :thread :owner :ownership "none")
    ("cna_sprite_batch_end" :uint32 (:uint64) :thread :owner :ownership "none")
    ("cna_sprite_batch_get_type_name_size" :uint32 (:uint64 :pointer) :thread :owner :ownership "none")
    ("cna_sprite_batch_copy_type_name" :uint32 (:uint64 :pointer :uint64 :pointer) :thread :owner :ownership "none")
    ("cna_keyboard_get_state" :uint32 (:uint64 :pointer) :thread :owner :ownership "none")
    ("cna_keyboard_get_state_for_player" :uint32 (:uint64 :uint32 :pointer) :thread :owner :ownership "none")
    ("cna_keyboard_state_init" :uint32 (:pointer) :thread :any :ownership "none")
    ("cna_keyboard_state_init_from_keys" :uint32 (:pointer :uint64 :pointer) :thread :any :ownership "none")
    ("cna_keyboard_state_get_key_state" :uint32 (:pointer :uint32 :pointer) :thread :any :ownership "none")
    ("cna_keyboard_state_equals" :uint32 (:pointer :pointer :pointer) :thread :any :ownership "none")
    ("cna_keyboard_state_get_hash_code" :uint32 (:pointer :pointer) :thread :any :ownership "none"))
  "Every native route this binding may call, with its bound CFFI shape.")
