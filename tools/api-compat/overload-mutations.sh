...
# wrong_overload_shape diagnostic each time, then requires a clean run.
#
# The last two exist because of the mechanism EffectParameter needed. Its
# eighteen SetValue overloads differ only in the type of the value; Common Lisp
...
echo "== 5. and the unmutated rules are green =="
...
echo "sharing one tag, and for a keyword set the real method does not have."
